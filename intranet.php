...
<div class="container">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-3">
            <a href="https://www.clinicalosangeles.org/reportes_clinicos.php" class="module-card" target="_blank">
                <div class="icon-box"><i class="fas fa-file-waveform"></i></div>
                <div class="module-title">Reportes Clínicos</div>
                <div class="module-desc">Visualización web de resultados.</div>
            </a>
        </div>
